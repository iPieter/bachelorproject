...
{ @NamedQuery( name = Issue.FIND_ALL, query = "SELECT i FROM Issue i" ),
		...
		@NamedQuery( name = Issue.FIND_BY_WORKPLACE_ID, query = "SELECT i FROM Issue i, " + "ProcessedSensorData d,"
				+ "Workplace w, " + "TrainCoach t "
...
public class Issue implements Serializable
{
	...
	/**
	 * @param inProgressTime
	 *            the inProgressTime to set
	 */
