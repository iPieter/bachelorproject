 ...
 * <p>
 * Processed sensor data can be quite big. In order to minimize loading times,
 * we have opted to load these files via AJAX. This REST endpoint allows
 * authenticated users to request these files.
 * 
...
public class ProcessedSensorDataRestService
{
	...
	/**
	 * Creates an empty ProcessedSensorDataRestService object. Needed for JavaEE
	 * to recognize this as a REST class.
	 */
	 ...
	 * <p>
	 * Exposes a GET path for /processed_data/{id} to the outside world. If
	 * found, it will return the json file, else it will return an error in json
	 * format.
	 * 
	 * @param id
	 *            The id of the file that's needed.
	 */
	@GET
	@Path( "{id}" )
	@Produces( "text/json" )
