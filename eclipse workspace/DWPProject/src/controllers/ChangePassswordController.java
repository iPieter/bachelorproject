...
/**
 * When a user wants to change his/her/(f)aer/eir/per/their/vis/xyr/hir
 * password, this controller is used.
 * <p>
...
public class ChangePassswordController implements Serializable
{
	...
	/**
	 * The function that's called by the JSF when the user confirms he wants to
	 * change his password.
	 * <p>
	 * Notice there's no safeguard to check if a password is what the user
	 * intended to type, this happens on the client side. Likely this is
